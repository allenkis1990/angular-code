/*jshint unused: vars */
define([
        'ahzj/kccs/js/common/stateMapper',
        'prometheus/directives/remote-validate',
        'uiRouterExtras',
        'oclazyload',
        'ahzj/kccs/js/center.home',
        'ahzj/kccs/js/states/home-state',
        'ahzj/kccs/js/common/hbFrontCommon',
        ...
        'ahzj/kccs/js/common/hbSkuModule',
        'ahzj/kccs/js/common/hb-notification',
        'angularSanitize',
        'ahzj/kccs/js/common/hbBootstrap'
    ],
