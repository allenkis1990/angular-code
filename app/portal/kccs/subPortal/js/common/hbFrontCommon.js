...
define(['angular', 'kccs/subPortal/js/directives/perfectOrder', 'jqueryNiceScroll'], function (angular, perfectOrder) {
    ...
    commonModule.directive('helpNav', ['$http', 'hbLoginService', '$state', '$rootScope', function ($http, hbLoginService, $state, $rootScope) {
        return {
            templateUrl: 'kccs/subPortal/views/home/helpNav.html',
    ...
    //获取登录票指令
        ...
        .directive('hbLoginForm', ['hbLoginService', '$interval', '$timeout', '$state', 'homeService', '$rootScope', 'hbBasicData', '$http', function (hbLoginService, $interval, $timeout, $state, homeService, $rootScope, hbBasicData, $http) {
            return {
                ...
                templateUrl: 'kccs/subPortal/views/home/loginDialog.html',
                scope: {},
                link: function ($scope) {
                    console.log($rootScope.porTitleName);
                    $scope.porTitleName=$rootScope.porTitleName;
                    $scope.fn = function () {
