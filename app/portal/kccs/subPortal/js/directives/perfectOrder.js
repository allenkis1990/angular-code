...
define(function () {
    ...
    return {
        ...
        perfectUserOrderInfo: ['hbBasicData', '$rootScope', '$http', function (hbBasicData, $rootScope, $http) {
            return {
                restrict: 'A',
                templateUrl: 'kccs/subPortal/templates/perfectUserOrderInfo.html',
                scope: {},
                link: function ($scope) {
                    ...
                    $scope.events = {
                        ...
                        openPerfectDetail: function (item) {
                            ...
                            var params = {
                                ...
                                commoditySkuIdList:[item.subOrderList[0].commoditySkuId]
                            };
        ...
        perfectDetail: ['hbBasicData', '$rootScope', '$http', 'hbUtil', '$dialog', function (hbBasicData, $rootScope, $http, hbUtil, $dialog) {
            return {
                restrict: 'A',
                templateUrl: 'kccs/subPortal/templates/perfectDetail.html',
                scope: {},
                link: function ($scope, ele, attrs) {
                    ...
                    $scope.model = {
                        ...
                        accountId:jsonStr.receiveAccountId,
                        commoditySkuIdList:jsonStr.commoditySkuIdList,
                        total: 0,
                        shiList: [],
                        quList: [],
                        userTake: '1',//1邮寄2自取
                            ...
                            $http.get('/web/front/studentOrder/getAssociatedOrder/' + item.subOrderNo).success(function (data) {
                                ...
                                if (data.status) {
                                    ...
                                    $dialog.contentDialog({
                                        ...
                                        modal: true,
                                        width: 1000,
                                        contentUrl: 'kccs/subPortal/templates/changeOrderDialog.html'
                                    }, $scope);
                    ...
                    $http.post('/web/front/distribution/findDeliveryMode',{accountId:$scope.model.accountId}).success(function (data) {
                        console.log(data);
                        if (data.status) {
                    ...
                    $http.post('/web/front/paymentChannel/getBillConfigByPaymentChannel', {placeChannelEnum: 'PRESENT',accountId:$scope.model.accountId,commoditySkuIdList:$scope.model.commoditySkuIdList}).success(function (data) {
                        if (data.status) {
                    ...
                    //获取自取点
                    $http.get('/web/front/distribution/listSelfStorage', {params: {type: undefined,accountId:$scope.model.accountId}}).success(function (data) {
                        if (data.status) {
