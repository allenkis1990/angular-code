define(['kccs/subPortal/js/modules/home/controllers/home-ctrl', 'jquery', 'cookie',
        'kccs/subPortal/js/modules/home/services/home-service',
        'kccs/subPortal/js/modules/home/controllers/top-ctrl',
        'kccs/subPortal/js/modules/home/controllers/footer-ctrl',
        ...
        return angular.module('app.front.states.accountant.main', [])
            ...
            .directive('scrollBanner', [function () {
                return {
                    scope: {},
                    restrict: 'AE',
                    templateUrl: 'kccs/subPortal/views/home/bannerTemplate.html',
                    link: function ($scope, ele, attr) {

                        $scope.bannerList = [
                            {
                                style: {
                                    background: 'url("kccs/subPortal/images/banner1.jpg") center top no-repeat',
                                    display: 'block'
                                }, current: true
                            },
                            {
                                style: {
                                    background: 'url("kccs/subPortal/images/banner2.jpg") center top no-repeat',
                                    display: 'none'
                                }, current: false
                            },
                            {
                                style: {
                                    background: 'url("kccs/subPortal/images/banner3.jpg") center top no-repeat',
                                    display: 'none'
                                }, current: false
                            },
                            {
                                style: {
                                    background: 'url("kccs/subPortal/images/banner4.jpg") center top no-repeat',
                                    display: 'none'
                                }, current: false
                            }
                        ];
