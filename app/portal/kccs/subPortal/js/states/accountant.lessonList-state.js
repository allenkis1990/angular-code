define(['kccs/subPortal/js/modules/lessonList/main'], function () {
    'use strict';
    angular.module('app.front.states.accountant.lessonList', [])
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider.state('states.accountant.lessonList', {
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'kccs/subPortal/views/lessonList/lessonList.html',
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'kccs/subPortal/views/lessonList/lessonViews.html',
