define(['kccs/subPortal/js/modules/onTraining/main'], function () {
    'use strict';
    ...
    angular.module('app.front.states.onTraining', [])
        ...
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider.state('states.accountant.onTraining', {
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'kccs/subPortal/views/onTraining/index.html',
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'kccs/subPortal/views/onTraining/onTrainingViews.html',
