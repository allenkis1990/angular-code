...
define ( function ( mod ) {
    'use strict';
    return {
        indexCtrl: ['$scope', '$rootScope', 'homeService', '$timeout', '$state', '$dialog', '$sce', '$interval','hbLoginService','$http','hbBasicData',
            function ( $scope, $rootScope, homeService, $timeout, $state, $dialog, $sce, $interval,hbLoginService,$http,hbBasicData ) {
                $scope.model = {
                    user               : {},
                    loginError         : '',
                    ...
                    portalSystemName:require.config_data_for_cms.name
                };

                console.log($rootScope.orgnizationsList);
                ...
                $scope.events             = {
                    ...
                    dialogNotice    : function () {
                      ...
                      /*      title     : '欢迎您参加安徽专业技术继续教育基地',*/
                            ...
                            width     : 600,
                            height : 300,
                            contentUrl: 'kccs/kccsv2/views/home/diaNotice.html'
                        }, $scope );
                    },
...
*/
                    ...
                    showMoreOrgnizations:function(){
                        hbBasicData.addOrgnizationsDialog($scope);
                    }


                };

                getSimpleList($scope.model.pxtzType,8,'pxtzList');
                getSimpleList($scope.model.zcfgType,8,'zcfgList');
