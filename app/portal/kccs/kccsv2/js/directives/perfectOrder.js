...
define(function () {
    ...
    return {
        ...
        perfectUserOrderInfo: ['hbBasicData', '$rootScope', '$http', function (hbBasicData, $rootScope, $http) {
            return {
                restrict: 'A',
                templateUrl: 'kccs/kccsv2/templates/perfectUserOrderInfo.html',
                scope: {},
                link: function ($scope) {
        ...
        perfectDetail: ['hbBasicData', '$rootScope', '$http', 'hbUtil', '$dialog', function (hbBasicData, $rootScope, $http, hbUtil, $dialog) {
            return {
                restrict: 'A',
                templateUrl: 'kccs/kccsv2/templates/perfectDetail.html',
                scope: {},
                            ...
                            $http.get('/web/front/studentOrder/getAssociatedOrder/' + item.subOrderNo).success(function (data) {
                                ...
                                if (data.status) {
                                    ...
                                    $dialog.contentDialog({
                                        ...
                                        modal: true,
                                        width: 1000,
                                        contentUrl: 'kccs/kccsv2/templates/changeOrderDialog.html'
                                    }, $scope);
