...
define(['angular'], function (angular) {
    ...
    function __HB_notification ($compile, $rootScope) {
        ...
        function createModuleDialog (_scope, templateUrl) {
            notificationService.templateUrl = templateUrl || 'kccs/kccsv2/templates/common/temp.html';
        ...
        function createContentDialog (_scope, title, contentUrl, options) {
            ...
            notificationService.contentDialogContentUrlTemplate = contentUrl || 'kccs/kccsv2/templates/common/temp.html';
