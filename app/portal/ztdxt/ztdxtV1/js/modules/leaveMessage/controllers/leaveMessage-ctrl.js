define(['kccs/kccsv2/js/common/zh-cn'], function (zhCn) {
    'use strict';
        ...
        $scope.events = {
            ...
            wantToLeaveMessage: function () {
                ...
                $dialog.contentDialog({
                    ...
                    visible: true,
                    modal: true,
                    contentUrl: 'kccs/kccsv2/views/leaveMessage/wangLeaveMessageDialog.html'
            ...
            deleteLeaveMessage: function (item) {
                ...
                $dialog.contentDialog({
                    ...
                    height: 150,
                    modal: true,
                    contentUrl: 'kccs/kccsv2/views/leaveMessage/deleteLeaveMessageDialog.html'
                }, $scope).then(function (data) {
