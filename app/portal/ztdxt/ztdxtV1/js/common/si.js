define(function () {
    ...
    return {
        'modules': [{
            ...
            'files': ['kccs/kccsv2/js/states/accountant-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.concatUs',
            'files': ['kccs/kccsv2/js/states/accountant.concatUs-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.creditVerification',
            'files': ['kccs/kccsv2/js/states/accountant.creditVerification-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.download',
            'files': ['kccs/kccsv2/js/states/accountant.download-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.forget',
            'files': ['kccs/kccsv2/js/states/accountant.forget-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.helpCenter',
            'files': ['kccs/kccsv2/js/states/accountant.helpCenter-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.helpCenterMobile',
            'files': ['kccs/kccsv2/js/states/accountant.helpCenterMobile-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.information',
            'files': ['kccs/kccsv2/js/states/accountant.information-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.laws',
            'files': ['kccs/kccsv2/js/states/accountant.laws-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.leaveMessage',
            'files': ['kccs/kccsv2/js/states/accountant.leaveMessage-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.lessonList',
            'files': ['kccs/kccsv2/js/states/accountant.lessonList-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.manageTransit',
            'files': ['kccs/kccsv2/js/states/accountant.manageTransit-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.notice',
            'files': ['kccs/kccsv2/js/states/accountant.notice-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.noticeViews',
            'files': ['kccs/kccsv2/js/states/accountant.noticeViews-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.onTraining',
            'files': ['kccs/kccsv2/js/states/accountant.onTraining-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.process',
            'files': ['kccs/kccsv2/js/states/accountant.process-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.registration',
            'files': ['kccs/kccsv2/js/states/accountant.registration-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.teleUs',
            'files': ['kccs/kccsv2/js/states/accountant.teleUs-state.js']
        }],
        'futureStates': [{
