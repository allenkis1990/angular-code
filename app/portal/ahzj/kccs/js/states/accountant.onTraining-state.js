define(['ahzj/kccs/js/modules/onTraining/main'], function () {
    'use strict';
    ...
    angular.module('app.front.states.onTraining', [])
        ...
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider.state('states.accountant.onTraining', {
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'ahzj/kccs/views/onTraining/index.html',
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'ahzj/kccs/views/onTraining/onTrainingViews.html',
