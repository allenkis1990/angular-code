        ...
        indexCtrl: ['$scope', '$rootScope', 'homeService', '$timeout', '$state', '$dialog', '$sce', '$interval', 'hbLoginService', '$http',
            function ($scope, $rootScope, homeService, $timeout, $state, $dialog, $sce, $interval, hbLoginService, $http) {
                ...
                $scope.events = {
                    ...
                    goChildren:function(name){
                        console.log(location);
                        var origin=location.origin;
                        var targetName=name+'kccs';
                        var targetName2 = name+'ahzj';
                        var childRenOrigin=origin.replace('kccs',targetName);
                        childRenOrigin=childRenOrigin.replace('ahzj',targetName2);
                        window.open(childRenOrigin);
                    },
                    ...
                    dialogNotice: function () {
                        $dialog.contentDialog({
                            ...
                            width: 700,
                            height: 'auto',
                            contentUrl: 'ahzj/kccs/views/home/diaNotice.html'
                        }, $scope);
                    },
                        ...
                        if (data.status) {
                            ...
                            angular.forEach($scope.model[listName], function (item) {
                                if (item.title.length > 25) {
                                    item.shortTitle = item.title.substr(0, 25) + '...';
                                } else {
