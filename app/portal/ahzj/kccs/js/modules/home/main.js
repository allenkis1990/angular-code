define(['ahzj/kccs/js/modules/home/controllers/home-ctrl', 'jquery', 'cookie',
        'ahzj/kccs/js/modules/home/services/home-service',
        'ahzj/kccs/js/modules/home/controllers/top-ctrl',
        'ahzj/kccs/js/modules/home/controllers/footer-ctrl',
        ...
        return angular.module('app.front.states.accountant.main', [])
            ...
            .directive('scrollBanner', [function () {
                return {
                    scope: {},
                    restrict: 'AE',
                    templateUrl: 'ahzj/kccs/views/home/bannerTemplate.html',
                    link: function ($scope, ele, attr) {

                        $scope.bannerList = [
                            {
                                style: {
                                    background: 'url(ahzj/kccs/images/banner1.jpg) center top no-repeat',
                                    display: 'block'
                                },
                                current: true
                            },
                            {
                                style: {
                                    background: 'url(ahzj/kccs/images/banner2.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            },
                            {
                                style: {
                                    background: 'url(ahzj/kccs/images/banner3.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            },
                            {
                                style: {
                                    background: 'url(ahzj/kccs/images/banner4.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            }
