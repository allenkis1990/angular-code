define(['ahzj/fykccs/js/modules/helpCenterMobile/main'], function () {
    'use strict';
    angular.module('app.front.states.accountant.helpCenterMobile', [])
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider.state('states.accountant.helpCenterMobile', {
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'ahzj/fykccs/views/helpCenterMobile/helpCenterMobile.html',
                ...
                views: {
                    'contentView@': {
                        templateUrl: 'ahzj/fykccs/views/helpCenterMobile/helpCenterMobileDetail.html',
