define(function () {
    ...
    return {
        'modules': [{
            ...
            'files': ['ahzj/fykccs/js/states/accountant-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.concatUs',
            'files': ['ahzj/fykccs/js/states/accountant.concatUs-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.creditVerification',
            'files': ['ahzj/fykccs/js/states/accountant.creditVerification-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.download',
            'files': ['ahzj/fykccs/js/states/accountant.download-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.forget',
            'files': ['ahzj/fykccs/js/states/accountant.forget-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.helpCenter',
            'files': ['ahzj/fykccs/js/states/accountant.helpCenter-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.helpCenterMobile',
            'files': ['ahzj/fykccs/js/states/accountant.helpCenterMobile-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.information',
            'files': ['ahzj/fykccs/js/states/accountant.information-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.laws',
            'files': ['ahzj/fykccs/js/states/accountant.laws-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.leaveMessage',
            'files': ['ahzj/fykccs/js/states/accountant.leaveMessage-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.lessonList',
            'files': ['ahzj/fykccs/js/states/accountant.lessonList-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.manageTransit',
            'files': ['ahzj/fykccs/js/states/accountant.manageTransit-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.notice',
            'files': ['ahzj/fykccs/js/states/accountant.notice-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.noticeViews',
            'files': ['ahzj/fykccs/js/states/accountant.noticeViews-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.onTraining',
            'files': ['ahzj/fykccs/js/states/accountant.onTraining-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.process',
            'files': ['ahzj/fykccs/js/states/accountant.process-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.registration',
            'files': ['ahzj/fykccs/js/states/accountant.registration-state.js']
        }, {
            'reconfig': true,
            'name': 'app.portal.states.accountant.teleUs',
            'files': ['ahzj/fykccs/js/states/accountant.teleUs-state.js']
        }],
        'futureStates': [{
