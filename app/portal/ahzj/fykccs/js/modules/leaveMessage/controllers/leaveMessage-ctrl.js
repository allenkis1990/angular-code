define(['ahzj/fykccs/js/common/zh-cn'], function (zhCn) {
    'use strict';
        ...
        $scope.events = {
            ...
            wantToLeaveMessage: function () {
                ...
                $dialog.contentDialog({
                    ...
                    visible: true,
                    modal: true,
                    contentUrl: 'ahzj/fykccs/views/leaveMessage/wangLeaveMessageDialog.html'
            ...
            deleteLeaveMessage: function (item) {
                ...
                $dialog.contentDialog({
                    ...
                    height: 150,
                    modal: true,
                    contentUrl: 'ahzj/fykccs/views/leaveMessage/deleteLeaveMessageDialog.html'
                }, $scope).then(function (data) {
