define(['ahzj/fykccs/js/modules/home/controllers/home-ctrl', 'jquery', 'cookie',
        'ahzj/fykccs/js/modules/home/services/home-service',
        'ahzj/fykccs/js/modules/home/controllers/top-ctrl',
        'ahzj/fykccs/js/modules/home/controllers/footer-ctrl',
        ...
        return angular.module('app.front.states.accountant.main', [])
            ...
            .directive('scrollBanner', [function () {
                return {
                    scope: {},
                    restrict: 'AE',
                    templateUrl: 'ahzj/fykccs/views/home/bannerTemplate.html',
                    link: function ($scope, ele, attr) {

                        $scope.bannerList = [
                            {
                                style: {
                                    background: 'url(ahzj/fykccs/images/banner1.jpg) center top no-repeat',
                                    display: 'block'
                                },
                                current: true
                            },
                            {
                                style: {
                                    background: 'url(ahzj/fykccs/images/banner2.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            },
                            {
                                style: {
                                    background: 'url(ahzj/fykccs/images/banner3.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            },
                            {
                                style: {
                                    background: 'url(ahzj/fykccs/images/banner4.jpg) center top no-repeat',
                                    display: 'none'
                                },
                                current: false
                            }
