            ...
            return {
                ...
                link: function ($scope) {
                    ...
                    (function () {
                        ...
                        result.push('<td title ="#:trainingSchemeType===\'TRAINING_CLASS\'?\'培训班学习\':\'自主选课学习\'#">');
                        result.push('#:trainingSchemeType===\'TRAINING_CLASS\'?\'培训班学习\':\'自主选课学习\'#');
                        result.push('</td>');
                    ...
                    $scope.selectClassGridOptions = hbUtil.kendo.grid.genGridCommonConfig(selectClassGridDataSource, classGridRowTemplate, [
                        ...
                        {field: 'attr', title: '培训方案形式', sortable: false, width: 230},
