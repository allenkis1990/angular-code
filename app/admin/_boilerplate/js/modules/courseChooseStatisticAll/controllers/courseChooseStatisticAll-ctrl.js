define(function () {
    'use strict';
    return ['$scope', 'courseChooseStatisticAllService', 'HB_dialog', 'KENDO_UI_GRID', 'kendo.grid', '$state', 'TabService','$rootScope',
        function ($scope, courseChooseStatisticAllService, HB_dialog, KENDO_UI_GRID, kendoGrid, $state, TabService, $rootScope) {
            ...
            $scope.events = {
                ...
                exportCourseStatistics: function () {
                    ...
                    courseChooseStatisticAllService.exportCourseStatistics({
            ...
            function getSubjectAndYear () {
                //获取科目
                //courseChooseStatisticAllService.getTitleLevelList().then(function(data){
                //    if(data.status){
                ...
                //});
                //获取年度
                //courseChooseStatisticAllService.getTrainingYearList().then(function(data){
                //    if(data.status){
                ...
                //    }
                //});
                courseChooseStatisticAllService.findProvider().then(function (data) {
                    if (data.status) {
