define ( function ( refundOrder ) {
    "use strict";
    return {
        indexCtrl: ["$scope", 'hbUtil', 'HB_dialog', 'TabService', '$http', '$timeout', '$rootScope', '$state', 'unitAdminServices', 'HB_notification',
...
*/
                ...
                (function () {
                    ...
                    result.push ( '<td>' );
                    result.push ( '购买人：#: buyer.name # 帐号：#:buyer.loginInput #' );
                    result.push ( '</td>' );
...
/*                                            tradeStartTimeMills: validateIsNull ( $scope.refundQueryParam.tradeStartTimeMills ) ? 0 : parseTimeStrToLong ( $scope.refundQueryParam.tradeStartTimeMills ),
                        ...
                        columns    : [
                            ...
                            { field: "firstGoods", title: "班级信息", sortable: false, width: 280 },
