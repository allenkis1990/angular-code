define(function () {
    'use strict';
    return ['$scope', 'supplierResourceService', 'HB_dialog', 'KENDO_UI_GRID', 'kendo.grid', '$state', 'TabService','$rootScope',
        function ($scope, supplierResourceService, HB_dialog, KENDO_UI_GRID, kendoGrid, $state, TabService, $rootScope) {
            ...
            $scope.events = {
                ...
                exportCourseStatistics: function () {
                    ...
                    supplierResourceService.exportCourseStatistics({
                ...
                getUnitInfo: function (dataItem) {
                    supplierResourceService.findUnitByParentId(dataItem.id).then(function (data) {
 ...
 /*           var dataSource = new kendo.data.HierarchicalDataSource({
            ...
            function getSubjectAndYear () {
                ...
                //    }
                //});
                supplierResourceService.findProvider().then(function (data) {
                    if (data.status) {
