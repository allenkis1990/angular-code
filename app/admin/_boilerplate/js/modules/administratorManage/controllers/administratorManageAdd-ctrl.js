define(function () {
    'use strict';
    return ['$scope', 'TabService', 'roleManageService', 'administratorManageService', '$state', 'KENDO_UI_GRID', 'KENDO_UI_TREE', 'kendo.grid', 'KENDO_UI_EDITOR', 'hbUtil',
        function ($scope, TabService, roleManageService, administratorManageService, $state, KENDO_UI_GRID, KENDO_UI_TREE, kendoGrid, KENDO_UI_EDITOR, hbUtil) {
            $scope.model = {
            ...
            $scope.events = {
                ...
                saveAdministrator: function (e) {
                    if ($scope.administratorValidate.$valid && $scope.model.save) {
                        ...
                        administratorManageService.createAdministrator($scope.model.createParam).then(function (data) {
                            if (data.status) {
                ...
                saveAndFinalStep: function (e) {
                    ...
                    administratorManageService.authorityBatchRole(administratorId, $scope.model.roleSelectedIdArray).then(function (data) {
            ...
            function findRoleMessage () {
                administratorManageService.getUserRoleListString($scope.model.createParam.administratorId).then(function (data) {
                    if (data.status) {
            ...
            (function () {
                ...
                result.push('<td>');
                result.push('<button type="button" class="table-btn" ng-click="events.viewRole(dataItem)" has-permission="administratorManage/queryRole">查看</button>');
                result.push('</td>');
