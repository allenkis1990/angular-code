define(function () {
    return ['Restangular', '$http', function (Restangular, $http) {
        ...
        var b = Restangular.withConfig(function (config) {
            config.setBaseUrl('/web/admin/paper/');
        });
        ...
        return {
            ...
            }, createPracticePaper: function (model) {
                return a.all('paper/createPracticePaper').post(model);
            }, practiceExamUpdateDto: function (model) {
                return a.all('paper/practiceExamUpdateDto').post(model);
            }, paperView: function (practiceExamId) {
                return a.one('paper/findPracticeExamById').get({practiceExamId: practiceExamId});
            },
            ...
            delPracticeExam: function (paperId) {
                return a.one('paper/delPracticeExam').get({practiceExamId: paperId});
            },
            ...
            findExamPaperTypeByParentId: function (id) {
                return c.one('findExamPaperTypeByParentId?parentId=' + id).get();
            },


            checkPracticeExamName: function (name) {
                return b.one('checkPracticeExamName').get(name);
            },
