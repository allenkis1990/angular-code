define(function () {
    'use strict';
    return ['$scope', 'infoContentService', 'infoCategoryService', '$state','$stateParams','KENDO_UI_EDITOR','$timeout',
        function ($scope, infoContentService, infoCategoryService, $state, $stateParams, KENDO_UI_EDITOR,$timeout) {
        ...
        infoContentService.findForUpdate($stateParams.id).then(function(data){
            if(data.status){
                ...
                $scope.model.newsDto.categoryType = data.info.categoryType;
