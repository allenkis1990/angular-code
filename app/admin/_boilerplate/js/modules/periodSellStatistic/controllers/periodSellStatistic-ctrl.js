define(function () {
    'use strict';
    return ['$scope', 'hbUtil', 'periodSellStatisticService', 'genQueryData', 'HB_dialog', 'KENDO_UI_GRID', 'kendo.grid', '$state', 'TabService',
        function ($scope, hbUtil, periodSellStatisticService, genQueryData, HB_dialog, KENDO_UI_GRID, kendoGrid, $state, TabService) {
            ...
            $scope.events = {
                exportCourseStatistics: function () {
                    ...
                    periodSellStatisticService.exportCommoditySaleStatistic({
                ...
                clearUserPageParams: function () {
                    ...
                    $scope.model.authorizedQuery.belongsType = '';
                    $scope.model.authorizedQuery.rangeType = '';
                },
