define(function () {
    'use strict';
    return ['$scope', 'HB_notification', 'hbUtil', '$http', 'questionService', 'kendo.grid', function ($scope, HB_notification, hbUtil, $http, questionService, kendoGrid) {
        $scope.model = {
            page: {
                pageSize: 10,
                pageNo: 1
            ...
            queryParam: {
                groupType: 'asynchExportTempClassLearningInfo', //异步任务组名
                startDate: null,
                endDate: null,
                status: '-1'
            },
        ...
        (function () {
            ...
            result.push('<td>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/queryLog"  ng-click="events.view($event,dataItem)" >查看日志</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage"  ng-if="#: group==\'asynchExportTempClassLearningInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载班级学习统计信息</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'asynchExportTempAreaLearningInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载地区学习统计信息</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'asynchExportTempUserActivatedInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载人员激活统计信息</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'courseChooseStatisticExport\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载地区选课统计信息</button>');

            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'asynchExportClassOpenInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载班级开通统计信息</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'asynchExportAreaOpenInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载地区开通统计信息</button>');
            result.push('<button type="button" class="table-btn" has-permission="reportFormsAsynExport/exportMessage" ng-if="#: group==\'asynchExportYearOpenInfo\' #" ng-click="events.downloadLogExcel($event,dataItem)" #: log.status ==\'executed\' && log.result &&log.result.success?\'\':\'disabled\'#>下载年度开通统计信息</button>');
