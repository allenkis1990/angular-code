...
define(['angular'], function (angular) {
    ...
    angular.module('HB_notifications', ['hb.util'])
        ...
        .directive('hbNotificationFasttip', Hb_fasttip)
    ...
    function __HB_notification ($compile, $rootScope) {
        ...
        function createModuleDialog (_scope, templateUrl) {
            notificationService.templateUrl = templateUrl || '@systemUrl@/templates/common/temp.html';
        ...
        function createContentDialog (_scope, title, contentUrl, options) {
            ...
            notificationService.contentDialogContentUrlTemplate = contentUrl || '@systemUrl@/templates/common/temp.html';
        ...
        function createDom (type, msg, arg) {
            ...
            switch (type) {
                ...
                case 'tip':
                    ...
                    break;
                case 'fastTip':
                    domHtml += '<div hb-notification-fasttip></div>';
                    break;
            }
            domHtml += '</div>';
        ...
        notificationService.showFastTip = function (msg, tipType) {
            createDom('fastTip', msg, tipType);
        };
        ...
        return {
            controller: function ($scope, $element) {
                ...
                this.closeWindow = function () {
                    if ($scope.confirming) return;
                    // 如果是ie8则没有动画效果，延迟0秒关闭
                    // 如果不是ie8 ， 延迟0.5秒关闭这个窗口

                    var timerSpeed = hbUtil.isIe() && hbUtil.isIe() <= 8 ? 0 : 400;
                ...
                this.doRightClose = function () {
                    if (HB_notification.openWindow) {
                        ...
                        HB_notification.confirmInShow = false;
                        HB_notification.openWindow.remove();
                        HB_notification.openWindow = null;
                    }
                };
                ...
                this.confirmCertain = function () {
                    ...
                    if (HB_notification.confirmCallBackFunction
                        ...
                        var promise = HB_notification.confirmCallBackFunction(_this);
                ...
                this.center = function ($dialog, fastTime) {
    ...
    function HB_confirm (HB_notification) {
        return {
            ...
            template: ['<div class="dialog animated">', '<div class="dialog-body">',
                '<div class="dialog-tit">b{{TIP_TITLE}}<a href="javascript:void(0);" class="ico ico-close" ng-click="closeWindow();"></a></div>',
                '<div class="dialog-cont" ng-bind-html="TIP_MSG"><!--b{{TIP_MSG}}--></div>', '<div class="btn-center">',
                '<div loading-biu  is-loading="confirming" text="确定" loading="confirmCertain()"></div>',
    ...
    function Hb_fasttip () {
        return {
            ...
            template: ['<div class="tip animated">',
                ...
                '</div>'].join(''),
            link: function ($scope, $element, $attr, parentController) {
                parentController.center($element, 1500);
            }
        };
    }
    ...
    function Hb_error_tip (HB_notification, $rootScope, $timeout, hbUtil) {
        return {
            ...
            template: ['<div class="tip animated fadeInDown">',
                ...
                '<a href="#" id="detail__" class="tip500_text">访问异常</a><div class="error-500-box animated">',
                ...
                '<span class="orderDetail" ng-click="msg.showMeItem=!msg.showMeItem">查看详情</span>', '</div>',
