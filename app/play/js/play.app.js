...
define(
    ...
    function (angular, artDialog, extend) {
        ...
        angular.module('app', ['ui.router', 'ngAnimate',
            ...
            .factory('commonService', ['$http', '$rootScope', 'hbPlayerBase', '$state', 'CONSTANT', '$timeout', 'localStorageService', '$log',
                function ($http, $rootScope, hbPlayerBase, $state, CONSTANT, $timeout, localStorageService, $log) {
                    return {
                        storageMap: {
                            // 登陆信息
                            loginInfo: 'dt001'
                ...
                function ($stateProvider, $urlRouterProvider, CONSTANT) {
                    ...
                    var states = {
                        states: {
                            ...
                            abstract: true,
                            resolve: {
                                login: ['$http', 'hbPlayerBase', '$q', 'localStorageService', 'commonService', '$state', '$stateParams', '$rootScope',
                                    function ($http, hbPlayerBase, $q, localStorageService, commonService, $state, $stateParams, $rootScope) {
                                        var I = $q.defer();
                                        // 记录用户是否登录
                                 ...
                                 *
                                 */
                                playInfo: ['$q', '$http', 'commonService', 'hbPlayerBase', 'login', '$state', '$urlMatcherFactory', '$stateParams', '$rootScope', '$timeout',
                                    function ($q, $http, commonService, hbPlayerBase, login, $state, $urlMatcherFactory, $stateParams, $rootScope, $timeout) {
                                        var defer = $q.defer();
                                        $rootScope.systemLoading = true;
                                        $http.get(hbPlayerBase.getLessonUrl($stateParams.lessonId,
                                            $stateParams.trainClassId, commonService.isLearn($stateParams.playMode), $stateParams.playMode), {
                                                // 10秒超时
                                                timeout: 15000
                                            })
                        ...
                        'states.home': {
                            url: '/:courseWareId/:goodsType?unitName',
                            resolve: {
                                playParams: ['$q', '$http', 'hbPlayerBase', 'commonService', '$stateParams', 'playInfo', '$state',
                                    function ($q, $http, hbPlayerBase, commonService, $stateParams, playInfo, $state) {
                                    ...
                                    controllerProvider: ['playParams', 'localStorageService', 'templateCode', '$interval', 'commonService', '$rootScope', '$stateParams',
                                        function (playParams, localStorageService, templateCode, $interval, commonService, $rootScope, $stateParams) {
                                            ...
                                            var businessController = ['$scope', 'hbPlayer', 'CONSTANT', 'commonService', '$state',
                                                '$timeout', 'hbPlayerBase', '$stateParams', '$http', '$rootScope',
                                                function ($scope, hbPlayer, CONSTANT, commonService, $state,
                                                    ...
                                                    $scope.$parent.currentPlayInfo = commonService.currentPlayInfo;
                                                            ...
                                                            angularThings: {
                                                                ...
                                                                errorInit: function (message) {
                                                                    ...
                                                                    if (commonService.isLearn($state.params.playMode)) {
                                                                        ...
                                                                        //如果有测验并且是第一次看完视频 提示测验
                                                                        if (window.location.href.indexOf('/learn') > -1) {
                                                                            if (!commonService.currentPlayParams.finishCourseProcess && commonService.hasTest) {
                                                                                dialog_({
                                                                                    title: '提示',
                                                                                    okValue: '立即进入',
                                                                                    cancel: function () {
                                                                                            ...
                                                                                            if (data.status) {
                                                                                                $http.get('/web/front/coursePaper/validCoursePractice', {
                                                                                                    params: {
                                                                                                        ...
                                                                                                        commoditySkuId: data.info.commoditySkuId
                                                                                                    }
                                                                                                }).success(function (data) {
                        ...
                        'preview': {
                            ...
                            resolve: {
                                playParams: ['$http', '$q', '$stateParams', 'hbPlayerBase', 'commonService', '$timeout', '$rootScope',
                                    function ($http, $q, $stateParams, hbPlayerBase, commonService, $timeout, $rootScope) {
                                        var defer = $q.defer();
                                        $rootScope.systemLoading = true;
            ...
            .directive('directory', ['$state', 'commonService', function ($state, commonService) {
                return {
